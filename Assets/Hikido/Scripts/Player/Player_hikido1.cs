...
public class Player_hikido1 : MonoBehaviour
{
    ...
    void Archercontrol()
    {
        ...
        {
            if (mouseleft == false && mouseright == false) { GetComponent<ArcherÅQskill_hikido>().NormalAttack(); }
            mouseleft = true;
        ...
        {
            if (mouseleft == true && mouseright == true) { GetComponent<ArcherÅQskill_hikido>().NormalAttack(); }
            mouseleft = false;
